//
//  ApiViewController2.swift
//  Study_RxSwift
//
//  Created by 최제환 on 2021/04/27.
//
...
class ApiController2 {
  ...
  /// The shared instance
  static var shared = ApiController2()

  /// The api key to communicate with openweathermap.org
  /// Create you own on https://home.openweathermap.org/users/sign_up
  private let apiKey = "9832be21d40d582151ecd6a7239b6458"
 ...
 */
public func iconNameToChar2(icon: String) -> String {
  switch icon {
  case "01d":
    return "\u{f11b}"
  case "01n":
...
extension ApiController2.Weather {
