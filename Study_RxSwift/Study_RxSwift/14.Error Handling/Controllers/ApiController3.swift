...
class ApiController3 {
    struct Weather: Decodable {
        ...
        init(from decoder: Decoder) throws {
            ...
            icon = iconNameToChar3(icon: info.first?.icon ?? "")
    ...
    /// The shared instance
    static var shared = ApiController3()
    
    /// The api key to communicate with openweathermap.org
    /// Create your own on https://home.openweathermap.org/users/sign_up
//    let apiKey = BehaviorSubject(value: "9832be21d40d582151ecd6a7239b6458")
 ...
 */
public func iconNameToChar3(icon: String) -> String {
    switch icon {
    case "01d":
        return "\u{f11b}"
    case "01n":
